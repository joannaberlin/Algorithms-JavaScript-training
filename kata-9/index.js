...
have been doing your boring real job, you've been 
...
feeling in the room to decide whether or not you should gather your 
things and leave.
...
happiness rating of the group. If <= 5, return 'Get Out Now!'. Else 
...
function outed(meet, boss) {
	...
	let totalScore = Object.values(meet).reduce((a, b) => a + b, 0);
	let overallHappiness = totalScore / Object.keys(meet).length;
